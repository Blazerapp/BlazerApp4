...
function renderMenu($highlighted_item_class){
    ...
    if (($loggedInUser->user_id == $master_account) && 0) {
        $hooks['#HEADERMESSAGE#'] = "<span class='navbar-center navbar-brand'>ADMINISTRATOR</span>";
    } else {
        $hooks['#HEADERMESSAGE#'] = "";
    }
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="../account/index.php"><img src="../logo.png" height=30 /> #WEBSITENAME#</a>
    #HEADERMESSAGE#
</div>
